      ...
      <div className="mx-auto max-w-6xl px-4 pb-20 pt-10">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-12">
          <aside className="lg:col-span-4">
            <div className="sticky top-24 rounded-2xl bg-white/85 p-5 shadow-[0_18px_60px_-28px_rgba(0,0,0,0.25)] ring-1 ring-black/10 backdrop-blur">
...
function Section({ id, title, children }: { id: string; title: string; children: ReactNode }) {
  return (
    <section
      id={id}
      className="rounded-2xl bg-white/85 p-6 shadow-[0_18px_60px_-28px_rgba(0,0,0,0.25)] ring-1 ring-black/10 backdrop-blur"
    >
